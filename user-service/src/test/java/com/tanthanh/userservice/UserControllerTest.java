...
import com.tanthanh.userservice.controller.RegisController;
...
class UserControllerTest {
    ...
    @InjectMocks
    private RegisController regisController;
    ...
    @BeforeEach
    public void setUp(){
        user = new User(1L,"dev@gmail.com","123456","employeeID",true,1L,1L,"ta","ta");
    ...
    void addUser(){
        ...
        Assertions.assertEquals(userDTO,regisController.registry(userDTO));
    }
    @Test
    void login(){
